export default {
  ...
  "tooltips.smartRes": "Elige una resolución según el nivel de detalle de la textura activa y la superficie del modelo, limitada por el presupuesto de triángulos.",
  "ui.smartResInfo": "Smart: <b>{edge} mm</b> · PPE {ppe} · pixel {pix} mm · superficie {area} cm² · ~{tris} triángulos",
  "ui.smartResBudgetCapped": "limitado por presupuesto",
