export default {
  ...
  "tooltips.smartRes": "Pick a resolution based on the active texture's detail and the model's surface area, capped to fit the triangle budget.",
  "ui.smartResInfo": "Smart: <b>{edge} mm</b> · PPE {ppe} · pixel {pix} mm · surface {area} cm² · est. {tris} triangles",
  "ui.smartResBudgetCapped": "budget-capped",
