export default {
  ...
  "labels.smartRes": "スマート",
  "tooltips.smartRes": "アクティブなテクスチャの精細さとモデル表面積から最適な解像度を選びます。三角形予算で上限が掛かります。",
  "ui.smartResInfo": "Smart: <b>{edge} mm</b> · PPE {ppe} · ピクセル {pix} mm · 表面 {area} cm² · 推定 {tris} 三角形",
  "ui.smartResBudgetCapped": "予算制限",
