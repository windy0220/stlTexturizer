export default {
  ...
  "tooltips.smartRes": "Choisit une résolution adaptée au niveau de détail de la texture active et à la surface du modèle, plafonnée par le budget de triangles.",
  "ui.smartResInfo": "Smart : <b>{edge} mm</b> · PPE {ppe} · pixel {pix} mm · surface {area} cm² · ~{tris} triangles",
  "ui.smartResBudgetCapped": "limité par le budget",
